...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ref={ref}
        className={cn(
            "flex h-10 w-full items-center justify-between whitespace-nowrap rounded-lg border border-zinc-200 bg-white px-3 py-2 ring-offset-white placeholder:text-black focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
            className,
        )}
        {...props}
    >
...
>(({ className, children, position = "popper", onSearch, ...props }, ref) => {
    ...
    return (
        <SelectPrimitive.Portal>
            ...
            >
                <div className="p-2">
                    <Input type="search" placeholder="Search..." value={search} onChange={handleSearch} className="h-8" />
                </div>
