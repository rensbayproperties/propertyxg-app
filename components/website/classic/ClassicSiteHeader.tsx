...
export function ClassicSiteHeader({ general }: { general: WebsiteGeneral }) {
  const accent = general.primaryColor || "#0166FF";

  return (
    <header className="sticky top-0 z-20 overflow-visible border-b border-neutral-200 bg-white font-sans">
