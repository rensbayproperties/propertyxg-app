...
const MINIMAL_ABOUT_PANEL = "#EAB308";
const MINIMAL_CTA_BG = "#EFB41F";

const MINIMAL_ABOUT_IMAGE = "/templates/minimal-template/burj-khalifa-image.webp";
    ...
    <div className="mx-auto flex min-h-[min(85vh,820px)] w-full max-w-[1920px] flex-col justify-center px-6 py-24 pr-[max(1.5rem,6vw)] sm:px-10 sm:pr-[max(2rem,8vw)] md:px-14 md:pr-[max(3rem,10vw)] lg:px-20 lg:py-32">
      <div className="max-w-[34rem] text-left">
        <h1
          ...
          style={{ color: MINIMAL_HERO_ACCENT }}
        >
...
const MINIMAL_FEATURES_HEADING = "#1B3366";

const WHY_CHOOSE_ITEMS = [
  {
    title: "Ultimate flexibility",
    body: "You're in control, with free cancellation and payment options to satisfy any plan or budget.",
    iconSrc: "/templates/minimal-template/ultimate-flexibility-minimal.webp",
  ...
  },
  {
    ...
    iconSrc: "/templates/minimal-template/memorable-experiences-minimal.webp",
    iconAlt: "Memorable experiences",
  },
  {
    title: "Quality at our core",
    body: "High-quality standards. Millions of reviews. A tourz company.",
    iconSrc: "/templates/minimal-template/quality-at-our-core-minimal.webp",
    iconAlt: "Quality at our core",
  },
  {
    title: "Award-winning support",
    body: "New price? New plan? No problem. We're here to help, 24/7.",
    iconSrc: "/templates/minimal-template/award-winning-support-minimal.webp",
    iconAlt: "Award-winning support",
  },
] as const;

const Features = (_props: TemplateSectionProps) => (
  <section className="bg-white py-16 font-sans md:py-20">
    <div className="mx-auto w-full max-w-[1200px] px-6 md:px-8 lg:px-12">
      <h2
        className="mb-10 text-3xl font-bold tracking-tight md:mb-12 md:text-[34px] md:leading-tight"
        style={{ color: MINIMAL_FEATURES_HEADING }}
      >
        Why choose us?
      </h2>
      <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-x-12 lg:gap-y-10">
        {WHY_CHOOSE_ITEMS.map((it) => (
          <div key={it.title} className="text-left">
            ...
            <img
              ...
              width={56}
              height={56}
              className="mb-5 h-14 w-auto max-w-[64px] object-contain object-left"
            />
            <h3
            ...
            <p className="mt-3 text-[15px] leading-[1.6] text-neutral-600">{it.body}</p>
          </div>
        ))}
      </div>
    </div>
...
const Listings = ({ general }: TemplateSectionProps) => (
  <section className="font-sans py-16 md:py-24">
    <div className="flex flex-col md:flex-row justify-center">
      <div className="relative md:w-[720px] h-[300px] sm:h-[340px] md:h-[420px] lg:h-[460px] shrink-0">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src={MINIMAL_ABOUT_IMAGE}
      ...
      <article
        className="flex flex-col justify-center px-10 py-12 text-white md:px-12 md:py-14 lg:px-16 lg:py-16 md:w-[480px] shrink-0"
        style={{ backgroundColor: MINIMAL_ABOUT_PANEL }}
      >
        <h2 className="text-4xl font-bold tracking-tight md:text-5xl">About us</h2>
        ...
        <button
          type="button"
          className="mt-8 inline-flex w-fit self-start rounded-sm border border-white bg-transparent px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-white/10"
        >
          More on Our History
        </button>
      </article>
...
const Cta = (_props: TemplateSectionProps) => (
  <section className="px-6 py-8 font-sans md:py-9" style={{ backgroundColor: MINIMAL_CTA_BG }}>
...
export const MINIMAL_SECTIONS: Record<
  WebsiteSectionId,
